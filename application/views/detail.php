...
<html>
    <head>
		...
		<link type="text/css" rel="stylesheet" href="<?php echo base_url('assets/css/detail.css'); ?>"/>
	...
	<body>
		...
		<nav>
			<div class="container">
				...
				<ul>
					<li><a href="<?php echo site_url('main/browse') ?>" class="active">Browse Things</a></li>
					<div class="mobile">
						<?php 
			...
			<div class="container">
				<div class="row">
					<div class="col-100">
						...
						if(isset($userID)){
							if($offered == false){
								if($det[0]->userID != $userID){
									if(empty($off_taken)){ ?>
									<a class="btn btn-yl" href="<?php echo site_url('main/offer').'/'.$det[0]->transID ?>">Give offer</a>
									<?php }
								}
							}
						}else{
